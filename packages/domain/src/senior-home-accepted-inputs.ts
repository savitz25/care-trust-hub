...
export const MA_ACCEPTED = {
  dphNursingHomes: MA.nursingHomes.rows,
  dphRestHomes: MA.restHomes.rows,
  ageAssistedLivingResidences: MA.assistedLiving.rows,
  cmsNursingHomes: MA.cmsOverlay.nursingHomes,
  cmsHomeHealth: MA.cmsOverlay.homeHealth,
  cmsHospice: MA.cmsOverlay.hospice,
  dphSourceAsOf: MA.dphWorkbook.sourceAsOf,
  alrSourceAsOf: MA.assistedLiving.sourceAsOf,
  snapshotAsOf: MA.snapshotAsOf,
};
export const TN_ACCEPTED = {
  hfcNursingHomeLicenses: TN.nursingHomes.distinctLicenseNumbers,
  hfcAclfs: TN.aclf.distinctLicenseNumbers,
  hfcRhas: TN.rha.distinctLicenseNumbers,
  cmsNursingHomes: TN.cmsOverlay.nursingHomes,
  cmsHomeHealth: TN.cmsOverlay.homeHealth,
  cmsHospice: TN.cmsOverlay.hospice,
  reportMonth: TN.nursingHomes.sourceAsOf,
  snapshotAsOf: TN.snapshotAsOf,
};

export const NV_ACCEPTED = {
  hcqcSnfLicenses: NV.skilledNursing.distinctCredentialNumbers,
  hcqcRfgs: NV.rfg.distinctCredentialNumbers,
  hcqcRfgAssistedLiving: NV.rfg.assistedLivingEndorsed,
  hcqcRfgAlzheimer: NV.rfg.alzheimerEndorsed,
  hcqcHircs: NV.hirc.distinctCredentialNumbers,
  cmsNursingHomes: NV.cmsOverlay.nursingHomes,
  cmsHomeHealth: NV.cmsOverlay.homeHealth,
  cmsHospice: NV.cmsOverlay.hospice,
