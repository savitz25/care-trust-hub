...
export const VA_PUBLIC_SNAPSHOT = {
  ...
  retrievedAt: "2026-09-10T16:02:10Z",
  snapshotAsOf: "2026-09-10",
  generatedAt: "2026-09-10T16:02:10Z",
  regulatorMap: {
    alfAgency: "Virginia Department of Social Services",
    alfDivision: "Division of Licensing Programs (DOLP)",
    alfSearch:
      "https://www.dss.virginia.gov/licensed-care/search-licensing-programs/assisted-living-facility-search/",
    alfHub: "https://www.dss.virginia.gov/licensed-care/assisted-living-facilities-alf/",
    adcSearch:
      "https://www.dss.virginia.gov/licensed-care/search-licensing-programs/adult-day-center-search/",
    ...
    vdhLtcSurveys:
      "https://www.vdh.virginia.gov/licensure-and-certification/division-of-long-term-care-services/ltc-inspections-surveys/",
  ...
  dssAlfInspections: {
    coverage: "ACQUIRED_CURRENT_SNAPSHOT",
    observationCount: 7032,
    facilitiesWithAtLeastOneObservation: 571,
    facilitiesWithZeroReturnedObservations: 2,
    violationFlagYes: 4066,
    violationFlagNo: 2966,
    complaintRelatedObservations: 2488,
  ...
  vdh: {
    nursingHomeInformationalPortal: {
      ...
      reason:
        "Interactive VDH OLC / Salesforce portal. No clean bulk download or structured public API found in this ticket.",
      url: "https://www.vdh.virginia.gov/licensure-and-certification/",
    },
    ltcInspectionLibrary: {
      coverage: "OPEN_SEARCH_ONLY",
      reason:
        "Per-facility survey/PDF library. Document-heavy; CMS already supplies the nursing-home backbone.",
    ...
    homeCareHospiceLicensing: {
      coverage: "OPEN_SEARCH_ONLY",
      reason:
        "OLC licensing portal is application/login oriented. No trivial statewide public roster.",
    },
  },
  publication: {
  ...
  expansionLedger: {
    ...
    NEW_VA_INSPECTION_OBSERVATION_ROWS: 7032,
    NEW_VA_COMPLAINT_RELATED_INSPECTION_ROWS: 2488,
    NEW_VA_VIOLATION_FLAGGED_INSPECTION_ROWS: 4066,
  ...
  fingerprint: "c98e5373d60c765690f03493e0c1fd85d4b24f2c4693fb964abd27b5d5d73d68",
} as const;
