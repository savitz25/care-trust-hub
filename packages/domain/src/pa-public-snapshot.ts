...
export const PA_PUBLIC_SNAPSHOT = {
  ...
  retrievedAt: "2026-09-16T20:15:00Z",
  generatedAt: "2026-09-17T13:10:40Z",
  regulatorMap: {
    dhsDirectory: "https://www.humanservices.dhs.pa.gov/human_service_provider_directory/",
    pchMonthly:
      "https://www.pa.gov/agencies/dhs/resources/data-reports/personal-care-homes-monthly-report",
    bhslReports:
  ...
  pchRoster: {
    ...
    PA_PCH_ROWS: null,
    PA_PCH_DISTINCT_FACILITY_IDS: null,
    PA_PCH_CURRENT_LICENSE_ROWS: null,
  ...
  alrRoster: {
    ...
    PA_ALR_ROWS: null,
    PA_ALR_DISTINCT_FACILITY_IDS: null,
    PA_ALR_CURRENT_LICENSE_ROWS: null,
  ...
  pchMonthlyReport: {
    ...
    PA_PCH_MONTHLY_REPORT_HOMES: 995,
    PA_PCH_MONTHLY_LICENSED_CAPACITY: 61906,
    PA_PCH_MONTHLY_RESIDENTS: 38898,
    ssiResidents: 3441,
    homesWithSsiResidents: 337,
    countyRows: 67,
    ...
    caveat:
      "Data is based on the most recent PCH inspection, which may have occurred within the prior year, and is not real-time.",
  },
  bhslAnnual: {
    coverage: "OPEN_SEARCH_ONLY",
  ...
  nursingHomes: {
    ...
    PA_NURSING_HOME_ROWS: 659,
    PA_NURSING_HOME_DISTINCT_STATE_IDS: 659,
    PA_NURSING_HOME_DISTINCT_CCNS: 647,
    licenseTypes: {
      REGULAR: 654,
      "PROVISIONAL I": 3,
      "PROVISIONAL II": 2,
    ...
    sha256: "3637443cd7150ca0384107bbdff753ee672d15305960a83aabab4543cdb0057a",
  },
  nursingHomeSanctions: {
    coverage: "ACQUIRED_CURRENT_SNAPSHOT",
    source: "DOH Report of Recent Nursing Homes Sanctions Q4 2025 PDF",
    PA_NURSING_HOME_SANCTION_ROWS: 1539,
    PA_NURSING_HOME_UNIQUE_SANCTIONS: 1533,
    distinctFacilityIds: 509,
    issueDateMin: "01/02/2020",
    issueDateMax: "12/30/2024",
  ...
  nursingHomeSurveys: {
    coverage: "OPEN_SEARCH_ONLY",
    PA_NURSING_HOME_SURVEY_ROWS: null,
  ...
  homeHealth: {
    ...
    PA_HOME_HEALTH_ROWS: 659,
    PA_HOME_HEALTH_STATE_IDS: 659,
    PA_HOME_HEALTH_CCNS: 403,
    medicareCertifiedRows: 412,
    licensedOnlyRows: 247,
  ...
  homeCare: {
    coverage: "ACQUIRED_CURRENT_SNAPSHOT",
    sourcePeriod: "2026-09",
    PA_HOME_CARE_ROWS: 4656,
    PA_HOME_CARE_STATE_IDS: 4656,
    byType: {
      "Home Care Agencies": 3431,
      "Home Care Agency/Registry": 1177,
      "Home Care Registry": 48,
    },
  ...
  adultDay: {
    coverage: "OPEN_SEARCH_ONLY",
    PA_ADULT_DAY_CENTER_ROWS: null,
    PA_ADULT_DAY_CENTER_DISTINCT_IDS: null,
  ...
  lifePace: {
    coverage: "ACQUIRED_CURRENT_SNAPSHOT",
    revised: "2026-08",
    PA_LIFE_PROVIDER_ROWS: 24,
    PA_LIFE_CENTER_ROWS: 58,
  ...
  crosswalk: {
    EXACT_PA_STATE_TO_CMS_BRIDGES: {
      nursing_home: 647,
      home_health_medicare: 403,
      hospice: 152,
      home_care: 0,
      pch: 0,
      alr: 0,
    ...
    EXACT_PA_STATE_TO_CMS_BRIDGES_TOTAL: 1202,
  ...
  expansion_ledger: {
    NET_NEW_STATE_RESEARCH_IDENTITIES: 6234,
  ...
  adverse_publication: {
    ...
    ADVERSE_ROWS_ACQUIRED: 1539,
    UNIQUE_REGULATORY_MATTERS: 1533,
    EXACT_PROFILE_ATTACHMENTS: 0,
    REVIEW_REQUIRED: 0,
    UNRESOLVED: 0,
    INTERNAL_ONLY: 0,
  ...
  dhhSha256: "8e82ac72cb5f04480a78e94615ace81da9e0e7be00083165b9824b4bf4933e6f",
  ncfSha256: "3637443cd7150ca0384107bbdff753ee672d15305960a83aabab4543cdb0057a",
