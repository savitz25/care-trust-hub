...
export const CO_PUBLIC_SNAPSHOT = {
  ...
  "asOf": "2026-09-09",
  "retrievedAt": "2026-09-09T18:00:00Z",
  "ticket": "CO-SEN-001",
  "regulatorMap": {
  ...
  "preIngestBaseline": {
    "cmsNursingHomeCcns": 210,
    "cmsHomeHealthCcns": 222,
    "cmsHospiceCcns": 88,
  ...
  "findings": [
    {
      ...
      "summary": "Accepted CMS geography lists 210 Nursing Homes, 222 Home Health agencies, and 88 Hospice providers in Colorado. Those class overlays already live in national CMS totals and are not added again.",
      "doesNotMean": [
  ...
  "noDenverPage": true,
  "statewideOnly": true,
  "fingerprint": "5f56bc927c981a15293f941cb794a317e3b2182100c1e7167dd7a78c0f57b9e3"
} as const;
