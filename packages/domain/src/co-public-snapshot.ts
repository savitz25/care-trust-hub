...
export const CO_PUBLIC_SNAPSHOT = {
  ...
  regulatorMap: {
    ...
    findAndCompareDashboard:
      "https://cohealthviz.dphe.state.co.us/t/HealthFacilitiesPublic/views/HealthFacilitySearchSite/1_HealthFacilitySearchSite",
    complaints:
      "https://cdphe.colorado.gov/health-facilities/file-a-complaint/health-facilities-complaint-contacts",
    complaintIntake:
      "https://docs.google.com/a/state.co.us/forms/d/e/1FAIpQLScLOLmW1TxB6ZqDcUivQkVOvtLHZc7OfXBEKDkgL-4valt22Q/viewform",
  ...
  cmsOverlay: {
    ...
    liveDirectoryCoUniqueCcn: {
      ...
      hospice: 88,
      source:
        "Accepted national geography partition; unique CCN counts in the current CMS class directories for state = CO.",
    },
    query: {
      nh: {
        ...
        unique_ccn: 210,
        method:
          "Deterministic slice from accepted senior-national-intelligence.json geography. National corpus was not re-downloaded.",
      },
      hha: {
  ...
  cdpheVerification: {
    ...
    dashboard:
      "https://cohealthviz.dphe.state.co.us/t/HealthFacilitiesPublic/views/HealthFacilitySearchSite/1_HealthFacilitySearchSite",
    window:
      "Inspection results and self-reported occurrences for surveys/events within the last 3 years",
    includes: [
    ...
    result:
      "Interactive dashboard / search path. No current official bulk facility roster was acquired this ticket.",
    scrape: "FORBIDDEN",
  ...
  staleGis2017: {
    ...
    description:
      "Point geometry of known regulated health facilities developed from HFEMSD addresses in January 2017.",
  ...
  crosswalk: {
    ...
    alrToCmsNh: {
      attempted: false,
      reason:
        "Assisted Living Residence is not a CMS Nursing Home class. Name/address join is forbidden.",
    },
    hcaToCmsHha: {
      attempted: false,
      reason:
        "No current bulk CDPHE HCA roster with official CMS numbers was acquired. Do not infer state license from CMS Home Health CCN.",
    },
    stateHospiceToCmsHospice: {
      attempted: false,
      reason:
        "No current bulk CDPHE hospice roster with official CMS numbers was acquired. Do not infer state license from CMS Hospice CCN.",
    },
    stateNfToCmsNh: {
      attempted: false,
      reason:
        "No current bulk CDPHE Nursing Care Facility roster with official Medicare IDs was acquired. CMS CCN remains the published identity for existing national NH routes. State license != CMS CCN unless exact.",
    },
  ...
  ownership: {
    ...
    cdphe:
      "Do not infer ownership for state-only facilities by name. Find and Compare is not scraped as an owner roster.",
  },
  publicationDecisions: {
    ...
    rationale:
      "Colorado state verification does not automatically create new public facility profiles without safe identity. Existing CMS public facility/provider profiles remain governed by current Senior publication rules.",
  },
  claimEligibility: {
    broadened: false,
  ...
  findings: [
    {
      ...
      summary:
        "Accepted CMS geography lists 210 Nursing Homes, 222 Home Health agencies, and 88 Hospice providers in Colorado. Those class overlays already live in national CMS totals and are not added again.",
      doesNotMean: [
    ...
    },
    {
      ...
      summary:
        "Find and Compare is an official dashboard for last-3-year inspections, citations, plans of correction, and self-reported occurrences. No current official bulk facility roster was acquired. Search-only is not zero.",
      doesNotMean: [
    ...
    },
    {
      ...
      summary:
        "Colorado Assisted Living Residences are licensed under 6 CCR 1011-1 Chapter 7. They are not Nursing Homes. No current ALR roster count is published here. Approximate press counts are rejected.",
      doesNotMean: [
    ...
    },
    {
      ...
      summary:
        "Colorado Information Marketplace dataset 98pp-s4r4 is a January 2017 address-derived point file. It is historical/stale and cannot be promoted to current identity.",
      doesNotMean: ["January 2017 locations are the current licensed universe"],
    },
    {
      id: "person-grain",
      title: "Nursing Home Administrator licenses are person-grain",
      summary:
        "DORA licenses Nursing Home Administrators as people. That path is a public research lookup, not a facility count, and does not mint person pages.",
      doesNotMean: [
  ...
  verification: {
    snapshot:
      "Accepted CMS Colorado class overlays plus CDPHE official verification/inspection paths",
