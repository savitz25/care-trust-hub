...
function textSize(value: string) {
  return value.length > 64 ? 32 : value.length > 46 ? 38 : 44;
}
  ...
  return new ImageResponse(
    (
      <div
        style={{
          ...
          background:
            "radial-gradient(circle at 50% 42%, #0b2743 0%, #06182c 40%, #020b1d 72%, #020817 100%)",
          color: "#fff",
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            display: "flex",
            background: `radial-gradient(circle at 50% 48%, ${config.accent}25 0%, transparent 44%)`,
          }}
        />
        <div
          style={{
        ...
        {nodes.map(([left, top, size], i) => (
          <div
            ...
            style={{
              ...
              height: size,
              borderRadius: 99,
              background: i % 2 ? "#38bdf8" : config.accent,
    ...
    ),
    {
      ...
      headers: {
        ...
        "X-TrustHub-Card-Revision": "share-004b-v1",
      },
    },
  );
}
