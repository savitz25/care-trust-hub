...
describe("senior homepage intelligence", () => {
  it("leads with intelligence and keeps classes separate", () => {
    ...
    expect(screen.getByRole("link", { name: /explore colorado intelligence/i })).toHaveAttribute(
      "href",
      "/colorado",
    );
    expect(screen.getByRole("link", { name: /explore virginia intelligence/i })).toHaveAttribute(
      "href",
      "/virginia",
    );
    ...
    expect(screen.getByRole("link", { name: /explore illinois intelligence/i })).toHaveAttribute(
      "href",
      "/illinois",
    );
    expect(screen.getByRole("link", { name: /explore oregon intelligence/i })).toHaveAttribute(
      "href",
      "/oregon",
    );
    expect(
      screen.getByRole("link", { name: /explore pennsylvania intelligence/i }),
    ).toHaveAttribute("href", "/pennsylvania");
    expect(
      screen.getByRole("link", { name: /explore north carolina intelligence/i }),
    ).toHaveAttribute("href", "/north-carolina");
    expect(screen.getByRole("link", { name: /explore ohio intelligence/i })).toHaveAttribute(
      "href",
      "/ohio",
    );
    expect(screen.getByRole("link", { name: /explore georgia intelligence/i })).toHaveAttribute(
      "href",
      "/georgia",
    );
    expect(
      screen.getByRole("link", { name: /explore massachusetts intelligence/i }),
    ).toHaveAttribute("href", "/massachusetts");
    expect(screen.getByRole("link", { name: /explore tennessee intelligence/i })).toHaveAttribute(
      "href",
      "/tennessee",
    );
    expect(screen.getByRole("link", { name: /explore nevada intelligence/i })).toHaveAttribute(
      "href",
      "/nevada",
    );
    expect(screen.getByRole("link", { name: /explore minnesota intelligence/i })).toHaveAttribute(
      "href",
      "/minnesota",
    );
