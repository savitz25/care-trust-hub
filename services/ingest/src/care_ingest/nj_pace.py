...
PRESS_20260108_URL = (
    "https://www.nj.gov/humanservices/news/pressreleases/2026/approved/20260108.shtml"
)
CMS_URL = "https://www.medicaid.gov/medicaid/long-term-services-supports/program-all-inclusive-care-elderly"
ARCGIS_URL = (
    "https://njdhs.maps.arcgis.com/apps/webappviewer/index.html?id=8237274139fc491e90a25e7ebf537d2b"
)
...
def parse_doas_page(html: str, *, retrieved: str, sha256: str) -> PaceCorpus:
    ...
    centers = [
        PaceCenter(
            "Capital Health LIFE",
            "Capital Health LIFE Bordentown",
            "Bordentown",
            "Burlington",
            "OPERATING",
        ),
        PaceCenter(
            ...
            "Trinity Health LIFE Pennsauken",
            "Pennsauken",
            "Camden",
            "OPERATING",
        ),
        ...
        PaceCenter(
            "Inspira LIFE", "Inspira LIFE Williamstown", "Williamstown", "Gloucester", "OPERATING"
        ),
        ...
        PaceCenter(
            ...
            "AtlantiCare LIFE Connection Atlantic City",
            "Atlantic City",
            "Atlantic",
            "OPERATING",
        ),
        PaceCenter(
            "WelbeHealth", "WelbeHealth Newark (awarded)", "Newark", "Essex", "IN_DEVELOPMENT"
        ),
        PaceCenter(
            "WelbeHealth", "WelbeHealth Paramus (awarded)", "Paramus", "Bergen", "IN_DEVELOPMENT"
        ),
        PaceCenter(
            "Senior LIFE",
            "Senior LIFE Bridgewater (awarded)",
            "Bridgewater",
            "Somerset",
            "IN_DEVELOPMENT",
        ),
        PaceCenter(
            "Senior LIFE", "Senior LIFE Wayne (awarded)", "Wayne", "Passaic", "IN_DEVELOPMENT"
        ),
    ]
    ...
    def full(org: str, center: str, county: str) -> None:
        areas.append(
            PaceServiceArea(org, center, "FULL_COUNTY", county, None, "OPERATING", None, DOAS_URL)
        )
    ...
    def zips(org: str, center: str, county: str, codes: list[str]) -> None:
        for code in codes:
            areas.append(
                PaceServiceArea(
                    org, center, "PARTIAL_COUNTY_ZIPS", county, code, "OPERATING", None, DOAS_URL
                )
            )
    ...
    zips(
        ...
        "Capital Health LIFE Bordentown",
        "Burlington",
        ["08015", "08016", "08022", "08060", "08068", "08505", "08515", "08518", "08554"],
    )
    areas.append(
        PaceServiceArea(
            "Trinity Health LIFE New Jersey",
    ...
    events = [
        PaceStatusEvent(
            ...
            date(2026, 1, 8),
            PRESS_20260108_URL,
            "pace|boldage|east-brunswick|2026-01-08|IN_DEVELOPMENT",
        ),
        PaceStatusEvent(
            "BoldAge PACE",
            "BoldAge PACE East Brunswick",
            ...
            None,
            DOAS_URL,
            "pace|boldage|east-brunswick|doas-current|OPERATING",
        ),
        PaceStatusEvent(
            "Lutheran Senior LIFE",
            "Lutheran Senior LIFE at Union",
            ...
            date(2026, 1, 8),
            PRESS_20260108_URL,
            "pace|lutheran|plainfield|2026-01-08|IN_DEVELOPMENT",
        ),
        PaceStatusEvent(
            "Lutheran Senior LIFE",
            "Lutheran Senior LIFE at Union",
            ...
            None,
            DOAS_URL,
            "pace|lutheran|plainfield|doas-current|OPERATING",
        ),
        PaceStatusEvent(
            "WelbeHealth",
            None,
            ...
            date(2026, 1, 8),
            PRESS_20260108_URL,
            "pace|welbehealth|2026-01-08|AWARDED",
        ),
        PaceStatusEvent(
            "Senior LIFE",
            None,
            ...
            date(2026, 1, 8),
            PRESS_20260108_URL,
            "pace|senior-life|2026-01-08|AWARDED",
        ),
    ]
    notes = [
...
def build_pace_report(corpus: PaceCorpus, *, dry_run: bool) -> PaceReport:
    operating_counties = {
        item.county for item in corpus.service_areas if item.operating_status == "OPERATING"
    }
    partial = {
        item.county
