...
- `CARE_ENABLE_CARE_NEEDS_NAVIGATOR=true`
- `CARE_ENABLE_SENIOR_CARE_COST_PLANNER=true`
- `CARE_ENABLE_FACILITY_INTERVIEW_BUILDER=true`
- `CARE_ENABLE_FAMILY_COMPARISON_WORKSPACE=true`
- `CARE_ENABLE_ASSISTED_LIVING_INTELLIGENCE` stays unset/false until Task 022
