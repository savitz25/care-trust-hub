...
async function measure(page) {
  return page.evaluate(() => {
    ...
    return {
      ...
      switchHub: r(sw),
      menu: r(menu),
      stackedBarPresent: bar && header && header.getBoundingClientRect().y > 20,
...
ok(d.h1 >= 56 && d.h1 <= 60, `desktop H1 ${d.h1} in 56–60`);
ok(d.h1Font && /georgia/i.test(d.h1Font), `desktop H1 serif ${d.h1Font}`);
...
ok(m.h1 >= 32 && m.h1 <= 36, `mobile H1 ${m.h1} in 32–36`);
